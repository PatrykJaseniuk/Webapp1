...
-- ================================================
-- Financial transactions: a signed ledger (negative = outflow, positive = inflow).
-- Scope is determined by the reference: lease-only (charges), property-only (expenses), or both (payments).
