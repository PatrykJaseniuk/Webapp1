...
CREATE INDEX idx_tenants_status ON public.tenants(tenant_status);
...
CREATE INDEX idx_leases_status ON public.lease_agreements(lease_status);
...
CREATE INDEX idx_leases_property_active ON public.lease_agreements(property_id, lease_status) 
