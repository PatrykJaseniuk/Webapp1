...
import { useSessionQuery, useUserRoleQuery, useSignOutMutation } from '@/backendConnectorWrapers/auth';
...
export const Layout = (): JSX.Element => {
  ...
  const roleQuery = useUserRoleQuery(userId);
