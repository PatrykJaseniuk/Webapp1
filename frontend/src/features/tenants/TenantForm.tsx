...
import { TENANT_STATUSES } from '@/domain';
...
const tenantToFormData = (tenant: Tenant): TenantFormData => ({
...
const formDataToInsert = (data: Readonly<TenantFormData>): TenantInsert => ({
...
type TenantFormProps = {
  ...
  readonly onSubmit: (data: TenantInsert) => Promise<void>;
