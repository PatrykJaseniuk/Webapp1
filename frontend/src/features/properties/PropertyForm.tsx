...
import { PROPERTY_TYPES, PROPERTY_STATUSES } from '@/domain';
...
const formDataToInsert = (data: Readonly<PropertyFormData>): PropertyInsert => ({
  name: data.name,
...
type PropertyFormProps = {
  ...
  readonly onSubmit: (data: PropertyInsert) => Promise<void>;
